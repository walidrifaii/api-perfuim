...
const register_admin_dto_1 = require("../admin/dto/register-admin.dto");
const login_dto_1 = require("../admin/dto/login.dto");
let AuthController = class AuthController {
    constructor(admins, auth) {
        this.admins = admins;
        this.auth = auth;
    }
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Login (JWT)' }),
...
AuthController = __decorate([
    ...
    __metadata("design:paramtypes", [admin_service_1.AdminsService, auth_service_1.AuthService])
], AuthController);
